...
export default function Philosophy() {
  return (
    <section className="relative overflow-hidden bg-[#1D283A] py-24 text-white md:py-32">
      {/* Background Atmosphere */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-[-150px] left-[-100px] h-[400px] w-[400px] rounded-full bg-[#C8B18B]/10 blur-[120px]" />

        <div className="absolute bottom-[-200px] right-[-100px] h-[450px] w-[450px] rounded-full bg-[#ffffff]/5 blur-[140px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-10 lg:px-16">
        ...
        <div className="max-w-3xl">
          ...
          >
            <div className="h-2 w-2 rounded-full bg-[#DCC8A5]" />

            <span className="text-xs uppercase tracking-[0.3em] text-[#E7D5B3]">
          ...
          >
            At Shree Vimal Vidya Mandir, education is designed to nurture
            character, curiosity, confidence, creativity, and compassion —
            helping every child grow into a capable and responsible individual.
          </motion.p>
        </div>

        {/* Philosophy Grid */}
        <div className="mt-20 grid grid-cols-1 gap-6 lg:grid-cols-12 auto-rows-auto">
          {philosophyCards.map((card, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-[34px] border border-white/10 bg-white/[0.04] backdrop-blur-xl ${card.className}`}
              >
                {/* Hover Glow */}
                ...
                <div className="absolute inset-0">
                  <img
                    src={card.image}
                    alt={card.title}
                    className="h-full w-full object-cover opacity-25 transition-transform duration-1000 group-hover:scale-105"
                  />

                  <div className="absolute inset-0 bg-gradient-to-b from-[#1D283A]/10 via-[#1D283A]/50 to-[#1D283A]" />
                </div>
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-7 md:p-9">
                  ...
                  <motion.div
                    ...
                    className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-[#E7D5B3] shadow-2xl backdrop-blur-xl"
                  >
